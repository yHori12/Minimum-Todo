...
class NewTaskItem(private val task: Task, private val listener: OnClickTaskItem) :
    BindableItem<ListItemNewTaskBinding>() {
    ...
    override fun bind(viewBinding: ListItemNewTaskBinding, position: Int) {
        ...
        viewBinding.completionToggle.setOnClickListener { listener.onClickComplete() }
    }
